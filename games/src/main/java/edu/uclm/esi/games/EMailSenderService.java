...
public class EMailSenderService {
	...
	public void enviarPorGmail(String email, String string) throws MessagingException {
        ...
        msg.setText("Pulsa en el siguiente enlace para crear una nueva contraseña: http://.localhost:8080/modifyPWD?code=" + string);
